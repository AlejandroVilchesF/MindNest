...
function Board({ board, onToggleNoteCompleted, onDescriptionChange}) {
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 p-4 flex space-x-4">
        {groupNotes(board.notes).map((group) => (<Note key={group.parentId} notes={group.notes} onToggleNoteCompleted={onToggleNoteCompleted} onDescriptionChange={onDescriptionChange}/>))}
